...
class OffsetDateTime(HttpType):
    ...
    def serialize(
        ...
        return ValueDict("OffsetDateTime", str(self._base)).serialize()
    ...
    def _deserialize(
        ...
        if value_dict is None:
            return None
        if value_dict.type_name != "OffsetDateTime":
            return None
        ...
        try:
            ...
            value_dict.invalid_value(
                f"invalid offset date time string {v!r}: {e}"
            )
            return None
        ...
        if obj is None:
            value_dict.invalid_value(
                f"must not contain time zone offset, but no zone name: {v!r}"
            )
        return obj
