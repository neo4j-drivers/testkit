 ...
 * A whitespace separated list of data fields in JOLT format.
   ...
   * Jolt has been extended for the Unsupported type. An example is `{"UT": ["QuantumFloat", 42, 67, "Only classical floats supported"]}`.  
     The general format is: `{"UT": ["<type name>", minimum_protocol_major, minimum_protocol_minor, "<optional message>"]}`.
   ...
   * Jolt has been extended for UUID types, e.g. `{"UU": "12345678-1234-1234-1234-123456789012"}`.
